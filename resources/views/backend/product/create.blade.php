        ...
        <div class="container-fluid">
            <form   enctype="multipart/form-data" action="{{route('product.store')}}" method="POST">
                ...
                @if ($errors->any())
                    ...
                    @endforeach
                @endif
                <input class="form-control    form-control-lg mb-3 mt-2"  name="name" type="text" placeholder="Ürün adı " >
                <div class="row">
                    <div class="col">
                ...
                <div class="col">
                    <input name="quantity" type="number" class="form-control" min="1" placeholder="Ürün Adedi">
                </div>
                </div>
                ...
                <div class="row ">
                    <div class="col">
                        <div class="card" style="width: 18rem;">
                            <img id="image" style="width: 288px;height: 432px" class="card-img-top" src="{{asset('/backend/images/image_holder.png')}}" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col">
                        ...
                        <select  name="attribute_ids[]" class="form-control form-control-lg mb-3 attributes"  multiple="multiple" >
                            <option disabled >Her Ürünün Normalde Özellikleri (ATTRİBUTE -RENK-MATERYAL VB OLAMALIDIR DEMO PROJESİ OLDUGUNDAN EKLENMEMİŞTİR detaylar modaterapim.com) </option>
